    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          />
          <img
            src="https://images.pexels.com/photos/1126993/pexels-photo-1126993.jpeg?auto=compress&cs=tinysrgb&w=1920"
            alt=""
            className="absolute top-0 right-0 w-1/3 h-1/3 object-cover"
          />
          <img
            src="https://images.pexels.com/photos/1152854/pexels-photo-1152854.jpeg?auto=compress&cs=tinysrgb&w=1920"
            alt=""
            className="absolute bottom-0 left-1/4 w-1/3 h-1/3 object-cover"
          />
        </div>
